...
namespace Test::Core
{
    void WidgetDefinesTest::initTestCase()
    {

    }

    void WidgetDefinesTest::cleanupTestCase()
    {

    }

    void WidgetDefinesTest::test_deleteActiveContentWidget()
    {
    ...
    void WidgetDefinesTest::test_updateWidgetStyle()
    {
        QWidget* widget = new QWidget();
        updateWidgetStyle(widget);
    }

    void WidgetDefinesTest::test_setWidgetErrorState()
    {
    ...
    void WidgetDefinesTest::test_setLabelNegativeState()
    {
    ...
    void WidgetDefinesTest::test_setWidgetStyleByProperty()
    {
    ...
    void WidgetDefinesTest::test_showInformation()
    {
